        ...
        public override void Resolve(ResolveParams rp)
        {
            ...
            if (num > 0)
            {
                ...
                for (int i = 0; i < num; i++)
                {
                    ...
                    //1.4
                    PawnGenerationRequest value = new PawnGenerationRequest(
                     faction.RandomPawnKind(), faction,
                    ...
                    false, false, false, false, true, 1f, true, true, true, true, false, false, false, false, false,
