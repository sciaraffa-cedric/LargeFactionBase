...
namespace LargeFactionBase
{
    ...
    {
        private static readonly IntRange LineLengthRange = new IntRange(20, 30);

        private static readonly IntRange GapLengthRange = new IntRange(0, 1);
        ...
        public override void Resolve(ResolveParams rp)
        {
            ...
            int num2 = 0;
            int num3 = -1;
            if (rp.rect.EdgeCellsCount < (SymbolResolver_EdgeWalls3.LineLengthRange.max + SymbolResolver_EdgeWalls3.GapLengthRange.max) * 2)
            {
                num = rp.rect.EdgeCellsCount;
            }
            else if (Rand.Bool)
            {
                num = SymbolResolver_EdgeWalls3.LineLengthRange.RandomInRange;
            }
            else
            {
                num2 = SymbolResolver_EdgeWalls3.GapLengthRange.RandomInRange;
            }
