...
namespace RimWorld.BaseGen
{
    ...
    {
        private const float MaxCoverage = 0.10f;
        ...
        public override bool CanResolve(ResolveParams rp)
        {
            ...
            if (BaseGen.globalSettings.basePart_batteriesCoverage + (float)rp.rect.Area / (float)BaseGen.globalSettings.mainRect.Area >= 0.10f)
            {
                return false;
            }
            if (rp.faction != null)
        ...
        /*public override bool CanResolve(ResolveParams rp)
        {
            return base.CanResolve(rp) && BaseGen.globalSettings.basePart_barracksResolved >= BaseGen.globalSettings.minBarracks 
                && BaseGen.globalSettings.basePart_batteriesCoverage + (float)rp.rect.Area / (float)BaseGen.globalSettings.mainRect.Area < 0.06f 
                && (rp.faction == null || rp.faction.def.techLevel >= TechLevel.Industrial);
        }*/ //2021-07-15
