...
namespace RimWorld
{
    public class LordJob_DefendBase2 : LordJob
    {
        private Faction faction;

        private IntVec3 baseCenter;

        public LordJob_DefendBase2()
        {
        }

        public LordJob_DefendBase2(Faction faction, IntVec3 baseCenter)
        {
        ...
        public override StateGraph CreateGraph()
        {
            ...
            LordToil_DefendBase2 lordToil_DefendBase = new LordToil_DefendBase2(this.baseCenter);
            stateGraph.StartingToil = lordToil_DefendBase;
            LordToil_DefendBase2 lordToil_DefendBase2 = new LordToil_DefendBase2(this.baseCenter);
            ...
            transition3.AddTrigger(new Trigger_PawnHarmed(0.1f, false, null));
            ...
            transition3.AddTrigger(new Trigger_ChanceOnPlayerHarmNPCBuilding(0.05f));
