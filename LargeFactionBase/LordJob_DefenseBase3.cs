...
namespace RimWorld
{
    public class LordJob_DefendBase3 : LordJob
    {
        private Faction faction;

        private IntVec3 baseCenter;

        public LordJob_DefendBase3()
        {
        }

        public LordJob_DefendBase3(Faction faction, IntVec3 baseCenter)
        {
        ...
        public override StateGraph CreateGraph()
        {
            ...
            LordToil_DefendBase3 lordToil_DefendBase = new LordToil_DefendBase3(this.baseCenter);
            stateGraph.StartingToil = lordToil_DefendBase;
            LordToil_DefendBase3 lordToil_DefendBase2 = new LordToil_DefendBase3(this.baseCenter);
            ...
            transition3.AddTrigger(new Trigger_PawnHarmed(0.01f, false, null));
            //transition3.AddTrigger(new Trigger_ChanceOnTickInteval(5000, 0.005f));
